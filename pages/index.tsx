        ...
        <div className={`transform transition-all duration-1000 ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} relative z-10 max-w-3xl w-full`}>
          <div className="space-y-8">
            ...
            <div className="text-xl text-[#556B2F] space-y-4 text-left">
              ...
              <p>you can reach me at <Link href="mailto:devk@umich.edu" className="underline transition-colors duration-300 hover:text-[#6B8E23]">devk[at]umich[dot]edu</Link> — i am also active on twitter and linkedin</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-[#F0F4E3] text-[#556B2F]">
        ...
        <section className="max-w-4xl mx-auto py-20 px-6 border-t border-[#D3D9C8] relative z-20">
          ...
          <div className="font-crimson flex flex-wrap gap-4">
            <span className="px-4 py-2 rounded-full bg-[#8F9779]/50 text-[#556B2F]">strength training</span>
            <span className="px-4 py-2 rounded-full bg-[#8F9779]/50 text-[#556B2F]">content creation</span>
            <span className="px-4 py-2 rounded-full bg-[#8F9779]/50 text-[#556B2F]">solo travel</span>
            <span className="px-4 py-2 rounded-full bg-[#8F9779]/50 text-[#556B2F]">exploring tech</span>
            <span className="px-4 py-2 rounded-full bg-[#8F9779]/50 text-[#556B2F]">community building</span>
          </div>
        </section>
      </div>
    </>
